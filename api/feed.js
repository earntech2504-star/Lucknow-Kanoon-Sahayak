...
export default async function handler(req, res) {
  ...
  // ============================================
  // AUTO TRENDING KEYWORDS 2026 - Daily Rotate
  // ============================================
  function getTrendingLegalTopics() {
    const today = new Date().getDate();
    const trending = [
      'BNS 318 Cheating', 'BNSS 173 FIR', 'BNSS 480 Bail',
      'IPC 420 to BNS', 'Cyber Crime 1930', 'Women Safety BNS 85',
      'Supreme Court Bail', 'BNSS 144 Maintenance', 'Zero FIR', 'Anticipatory Bail'
    ];
    return trending[today % trending.length];
  }
  ...
  // ============================================
  try {
    const trendingTopic = getTrendingLegalTopics();
    ...
    return res.status(200).json({
      ...
      message: `📢 Trending: ${trendingTopic}`
    });
